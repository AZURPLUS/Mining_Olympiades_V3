...
class GestionAdherent
{
	...
	$listeEntreprise = [
            ...
            "ISAO",
            "BDO", 
            "TOTAL ENERGIES MARKETING CI",
            "PRO WORK INTERNATIONAL SERVICES (PWIS)", 
            "OLEA ASSURANCES",
            "PANORAMA TECHNOLOGIES",
            "KUYO PIPELINE CONSTRUCTION ET MAINTENANCE",
            "ANYWR CÔTE D'IVOIRE", 
            "STANDARD WAYS, INC",
            "EXPERTIS CONSULTING",
            "SOCIETE DE NETWORKING DE SALARIES (SNS)",
            "GARDIAN'S ASSISTANCE",
            "EMH SERVICES SARLU",
            "SOUDOTEC",
            "ELITE INTERIM",
            "FLYTH FISCAL & JURIDIQUE",
            "TIPICI SARL",
            "AECI CÔTE D'IVOIRE",
            "MARINE & OIL SERVICES SARL (MAROIL)",
            "EPIROC CÔTE D'IVOIRE",
            "NOVELIA ASSURANCES",
            "PARTECH SA",
            "BERNABE CÔTE D'IVOIRE",
            "SCHNEIDER ELECTRIC",
            "SCPA PARIS-VILLAGE",
            "AFRICA EXTRACTIVE PARTNERS",
            "BANQUE ATLANTIQUE",
            "FORVIS MAZARS",
            "CONSEILS ASSOCIES EN AFRIQUE - C2A", 
            "SOGEA-SATOM COTE D'IVOIRE",
            "AWALE RESOURCES",
            "SWITCH METALS COTE D'IVOIRE",
            "PLUSOR COTE D'IVOIRE",
            "LOUDA INDUSTRY COTE D'IVOIRE",
            "BGFIBANK COTE D'IVOIRE",
            "BCM COTE D'IVOIRE",
            "CDU MINING SARL",
            "FORAGE FTE DRILLING CI",
            "IDC CÔTE D'IVOIRE",
            "BCM-TSR SA"
        ];
