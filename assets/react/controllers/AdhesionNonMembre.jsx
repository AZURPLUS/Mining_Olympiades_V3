...
export default function () {
  ...
  const [fermerInscription, setFermerInscription] = useState(false);
  ...
  const handleSubmit = async (e) => {
    ...
    // Enlever cette condition pour réouvrir les inscriptions
    if (!fermerInscription) {
      ...
      try {
        ...
        console.error(
          "Une erreur s'est prPageScientifiqueoduite lors de la soumission du formulaire :",
          error
        );
              ...
              <div className="col-xl-10">
                ...
                >
                  ...
                  >
                    ...
                    >
                      Les inscriptions pour la 8ᵉ édition des Mining Olympiades
                      sont officiellement clôturées ; nous remercions tous les
                      participants pour leur engouement et vous donnons
                      rendez-vous pour un événement inoubliable !
                    </h4>
                  </div> */}
                      ...
                      <div className="col">
                        <div className="form-floating">
                          <input
                            ...
                            value={prenoms}
                            onChange={(e) =>
                              setPrenoms(e.target.value.toUpperCase())
                            }
                          />
                          <label htmlFor="floatingInput">
                            Prénoms <span>*</span>
                      ...
                      <div className="col">
                        <div className="form-floating">
                          <input
                            ...
                            value={fonction}
                            onChange={(e) =>
                              setFonction(e.target.value.toUpperCase())
                            }
                          />
                          <label htmlFor="_fonction">
                            Fonction <span>*</span>
                          </label>
                        </div>
                      </div>
                      <div className="col">
                        <div className="form-floating">
                          <input
                            ...
                            value={entreprise}
                            onChange={(e) =>
                              setEntreprise(e.target.value.toUpperCase())
                            }
                          />
                          <label htmlFor="_entreprise">
