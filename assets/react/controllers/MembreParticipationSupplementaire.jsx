            ...
            <div className="col-xl-10">
              {abonnement.restantJoueur > 0 ? (
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="row mb-5 justify-content-center align-content-center">
                      <div className="col-12 mb-1">
                        <h3 className="titre text-center">
                          Formulaire de participation
                        </h3>
                        <h5 className="abonnement text-left">
                          Il reste encore{" "}
                          <span>{abonnement.restantJoueur}</span>{" "}
                          {abonnement.restantJoueur > 1
                            ? "participants"
                            : "participant"}{" "}
                          à inscrire.
                        </h5>
                        ...
                        <a
                          href="/membre/modification"
                          className="lien-modification"
                        >
                    ...
                    <div className="row row-cols-1 row-cols-lg-2 g-4 no-gutters">
                      <div className="col">
                        <div className="form-floating">
                          ...
                          >
                            <option>
                              -- Choisissez la discipline de compétition --
                            </option>
                            <option value=""></option>
                      ...
                      <div className="col">
                        <div className="mb-3">
                          <label htmlFor="">
                            Carte professionnelle <span>*</span>
                          </label>
                          <input
                            className="form-control form-control-lg"
                            type="file"
                ...
                <div>
                  ...
                  <a href="/membre/modification" className="lien-modification">
                    Changer de discipline
                  </a>
                </div>
              )}
