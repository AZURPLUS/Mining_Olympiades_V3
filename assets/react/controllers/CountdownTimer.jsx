...
function CountdownTimer({ targetDate }) {
  ...
  const eventDateTms = eventDate.getTime();
  console.log("targetDateTms", eventDateTms + ";" + "ce jour", currentDateTms);
  ...
  return (
    <>
      ...
      <div className="d-none d-lg-block">
          ...
          >
            ...
            >
              <div className="d-flex align-items-center flex-column">
                ...
                >
                  {timeLeft.days}
                  <span style={{ color: "#0b8e36", marginLeft: "10px" }}>
                    :
                  </span>
                </p>
        ...
        {/* {currentDate > eventDate && <div>welcome !</div>} */}
      </div>
