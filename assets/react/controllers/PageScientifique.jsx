                      ...
                      <div className="col">
                        <div className="form-floating">
                          <input
                            ...
                            value={niveau}
                            onChange={(e) =>
                              setNiveau(e.target.value.toUpperCase())
                            }
                          />
                      ...
                      <div className="col-12 mt-3">
                        <div className="form-check">
                          ...
                          <label className="form-check-label" htmlFor="_image">
                            <em>
                              En remplissant ce formulaire, j'accorde au comité
                              d'organisation l'autorisation d'utiliser mon image
                              à des fins de promotion de cet événement, que ce
                              soit sur des supports physiques ou numériques, y
                              compris pour les éditions à venir.
                            </em>
                          </label>
                        </div>
                      </div>
