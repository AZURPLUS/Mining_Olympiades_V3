      ...
      {loading ? (
        ...
        <section id="inscription">
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="row row-cols-1 row-cols-lg-2 g-4 no-gutters">
                      ...
                      <div className="col">
                        <div className="form-floating">
                          <input
                            ...
                            value={compagnie}
                            onChange={(e) =>
                              setCompagnie(e.target.value.toUpperCase())
                            }
                          />
                          <label htmlFor="floatingInput">
                            Compagnie <span>*</span>{" "}
                      ...
                      <div className="col">
                        <div className="form-floating">
                          <input
                            ...
                            value={secteur}
                            onChange={(e) =>
                              setSecteur(e.target.value.toUpperCase())
                            }
                          />
                          <label htmlFor="floatingInput">
                            Secteur <span>*</span>{" "}
                      ...
                      <div className="col lien-modal">
                        <em>
                          ...
                          <a href="#" onClick={handleCliquezIciClick}>
                            {" "}
                            Cliquez ici
                          </a>
                        </em>
                    ...
                    <div className="row mt-5 d-flex justify-content-center align-content-center align-items-center">
                      <div className="col-12 col-lg-10 col-xl-6 d-grid gap-2">
                        <input type="hidden" name="objet" value={props.titre} />
                        <button
                          type="submit"
          ...
          >
            ...
            <Modal.Body>
              {/* <img
                src="/assets/images/lancement.png"
                alt=""
                className="img-fluid"
                loading="lazy"
              /> */}
              ...
              <img
                src="/assets/images/offre_de_sponsoring.png"
                alt=""
                className="img-fluid"
                loading="lazy"
              />
