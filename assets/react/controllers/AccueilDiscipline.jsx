            ...
            <section id="discipline">
                <div className="disciplines">
                    ...
                    <div className="row mt-5">
                        <div className="col-12 col-lg-4"  data-aos="flip-left" data-aos-duration="3000" data-aos-delay="100">
                        ...
                        <div className="col-12 col-lg-4 mt-5 mt-lg-0"  data-aos="zoom-out" data-aos-duration="3000" data-aos-delay="100">
                            <img src="/assets/images/sport.png" alt="" className="img-fluid" />
                        </div>
                        <div className="col-12 col-lg-4 mt-5 mt-lg-0" data-aos="flip-right" data-aos-duration="3000" data-aos-delay="100">
                            <div className="row gap-2">
